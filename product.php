            ...
            <div class="box-product-item">
                ...
                <div class="products">
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/gg/cl13.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3>Xe Porsche</h3>
                            <span>3.540.000.000 VNĐ <u></u></span>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/mlb/13.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3> Xe Toyota</h3>
                            <span>950.050.000 VNĐ<u></u></span>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/lv/12.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3>Xe Ferrari</h3>
                            <span>5.589.000.000 VNĐ<u></u></span>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/lv/13.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3>Xe Honda</h3>
                            <span>1.000.000.000 VNĐ<u></u></span>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/lv/14.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3>Xe Hyundai</h3>
                            <span>1.200.000.000 VNĐ<u></u></span>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/dr/13.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3>Xe Lamborghini</h3>
                            <span>7.350.000.000 VNĐ<u></u></span>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/gg/cl14.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3> Xe Rolls-Royce</h3>
                            <span>15.000.000.000 VNĐ <u></u></span>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/mlb/14.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3>Xe Lexus</h3>
                            <span>2.378.000.000 VNĐ <u></u></span>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="image">
                            <img src="../image/dr/14.jpg" alt="">
                        </div>
                        <div class="product-title">
                            <h3>Xe Mercedes-Benz</h3>
                            <span>4.690.000.000 VNĐ <u></u></span>
                        </div>
                    </div>
