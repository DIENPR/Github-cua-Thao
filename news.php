            ...
            <div class="wrapper-news">
                <div class="news-center">
                    <a href="../html/newsinformation.html">
                        <div class="news-item">
                            <div class="image">
                                <img src="../image/mau01.jpg" alt="">
                            </div>
                            <div class="title-news">
                                <h2>Chọn mẫu ô tô theo sở thích</h2>
                                <p>Chọn một chiếc xe mới có thể là một trải nghiệm thú vị, nhưng cũng có thể khó khăn. Bằng cách dành thời gian để nghiên cứu các lựa chọn của bạn và đưa ra quyết định sáng suốt, bạn có thể tìm thấy chiếc xe hoàn hảo phù hợp với nhu cầu và sở thích của mình.</p>
                            </div>
                        </div>
                    </a>
                    <a href="../html/newsinformation.html">
                        <div class="news-item">
                            <div class="image">
                                <img src="../image/nhãn hiệu.jpg" alt="">
                            </div>
                            <div class="title-news">
                                <h2>Chọn các nhãn hiệu của xe</h2>
                    ...
                    <a href="../html/newsinformation.html">
                        <div class="news-item">
                            <div class="image">
                                <img src="../image/sothich.jpg" alt="">
                            </div>
                            <div class="title-news">
                                <h2>Chọn kiểu xe theo sở thích</h2>
                                <p>Nghiên cứu các mẫu xe khác nhau và so sánh các chất liệu được sử dụng trước khi đưa ra quyết định. Bạn cũng nên lái thử một số chiếc xe khác nhau để tìm thấy chiếc xe phù hợp nhất với nhu cầu của bạn.</p>
                            </div>
                        </div>
                    </a>
                    <a href="../html/newsinformation.html">
                        <div class="news-item">
                            <div class="image">
                                <img src="../image/dangxe.jpg" alt="">
                            </div>
                            <div class="title-news">
                                <h2>Chọn kiểu dáng ô tô</h2>
                                <p>Khi chọn kiểu dáng xe, bạn nên cân nhắc nhu cầu sử dụng của mình. Nếu bạn cần một chiếc xe để đi làm hàng ngày, một chiếc sedan hoặc hatchback có thể là lựa chọn tốt. Nếu bạn cần một chiếc xe để chở gia đình đi chơi, một chiếc SUV hoặc minivan có thể là lựa chọn tốt hơn. Nếu bạn cần một chiếc xe để chở hàng hóa, một chiếc xe tải có thể là lựa chọn tốt nhất.</p>
                            </div>
                        </div>
                    </a>
